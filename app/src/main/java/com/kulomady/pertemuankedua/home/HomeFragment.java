...
public class HomeFragment extends Fragment{
    ...
    public void renderTask() {
        for (int i = 0; i < 20; i++) {
            ...
            task.setId(i);
            task.setTask("Masak");
            task.setTaskTitle("title " + i);
            task.setCreateAt("Now");
            task.setTaskPhoto("http://cdn.klimg.com/merdeka.com/i/w/news/2013/08/02/229996/670x335/pintar-masak-tak-termasuk-dalam-ciri-wanita-sempurna.jpg");
            taskList.add(task);
        }
